...
static const mp_rom_map_elem_t board_module_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_MODE_L), MP_ROM_PTR(&pin_GPIO14) },
    { MP_ROM_QSTR(MP_QSTR_GP14), MP_ROM_PTR(&pin_GPIO14) },
    
    { MP_ROM_QSTR(MP_QSTR_MODE_R), MP_ROM_PTR(&pin_GPIO15) },
    ...
    { MP_ROM_QSTR(MP_QSTR_INT1), MP_ROM_PTR(&pin_GPIO22) },
    { MP_ROM_QSTR(MP_QSTR_GP22), MP_ROM_PTR(&pin_GPIO22) },

    { MP_ROM_QSTR(MP_QSTR_INT2), MP_ROM_PTR(&pin_GPIO23) },
